    ...
    zod.object({
      ...
      componentIndicators: zod.array(
        zod.object({
          ...
          qualitativeQuestion: zod.string().nullish(),
          quantitativeQuestion: zod.string().nullish(),
          position: zod.number(),
          createdAt: zod.date(),
          updatedAt: zod.date(),
        }),
...
export const CreateComponentIndicatorBody = zod.object({
  ...
  qualitativeQuestion: zod.string().optional(),
  quantitativeQuestion: zod.string().optional(),
