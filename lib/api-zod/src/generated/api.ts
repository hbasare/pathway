 ...
 */
export const GetProgramLogframeResponse = zod.object({
        ...
        zod.object({
          ...
          components: zod.array(
            zod.object({
              ...
              directBeneficiaries: zod.string(),
              indirectBeneficiaries: zod.string(),
              pathway: zod.enum(["direct", "indirect"]).nullish(),
...
export const CreateComponentBody = zod.object({
  ...
  directBeneficiaries: zod.string().optional(),
  indirectBeneficiaries: zod.string().optional(),
  pathway: zod.enum(["direct", "indirect"]).nullish(),
